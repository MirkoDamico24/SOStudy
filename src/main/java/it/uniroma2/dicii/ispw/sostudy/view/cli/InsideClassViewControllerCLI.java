...
public class InsideClassViewControllerCLI extends BaseControllerCLI {
    ...
    public void start() {
        while (true) {
            clearConsole();
            String className = nav.getCurrentClass().getClassName();
            printStandardHeader("Classe: " + className);
            printNavBar();
            ...
            if (choice.equals("H")) {
                ...
                nav.goToHomeView();
                return;
            } else if (choice.equals("C") && getCurrentUserRole() == UserRole.PROFESSOR) {
                nav.setPreviousView(Views.INSIDECLASSVIEW);
                nav.goToCreateTestView();
                return;
            } else if (choice.equals("I") && getCurrentUserRole() == UserRole.PROFESSOR) {
            ...
            try {
                ...
                if (selectedInt >= 1 && selectedInt < index) {
